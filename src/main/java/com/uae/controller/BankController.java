...
public class BankController {
	 ...
	 @Autowired
	    ...
	    public String showFirstService() {
	        ...
	        String serviceId = "BANK-SERVICE".toLowerCase();
	        ...
	        try {
	            ...
	            String url = "http://" + serviceInstance.getHost() + ":" + serviceInstance.getPort() + "/bank/txn?xrNo=manik";
	...
	/* @GetMapping("/txn")
	    public List getTransactionDetails(@RequestParam String xrNo) {
		 ...
		 System.out.println("Entering invoking 1st microservice");
		 String response = restTemplate.getForObject("http://bank-service:8080/bank/txn?xrNo=manik",String.class);
